...
async verify(mobileotp:string,emailotp:string)
{
  ...
  let cc=[{"route":"verify"},[{"mobileotp":mobileotp,"emailotp":emailotp}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
}
...
async stack(topupamt:number,durationid:number)
{
  ...
  let cc=[{"route":"stack"},[{"topupamt":topupamt,"durationid":durationid}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
}
...
async transferfund(topupamt: number, cuserid: string, otp:string) {
  ...
  let cc=[{"route":"transferfund"},[{"amount":topupamt,"cuserid":cuserid, "otp":otp}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
}

async reqsattlement(topupamt: number, cuserid: string, otp:string) {
  
  let cc=[{"route":"reqsattlement"},[{"amount":topupamt,"cuserid":cuserid, "otp":otp}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
}
async topupbywallet(topupamt:number,cuserid:string)
{
  ...
  let cc=[{"route":"topupbywallet"},[{"topupamt":topupamt,"cuserid":cuserid}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
}
...
async leveltopup(topupamt:number,cuserid:string)
{
  ...
  let cc=[{"route":"leveltopup"},[{"topupamt":topupamt,"cuserid":cuserid}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
}
async leveltopupbywallet(topupamt:number,cuserid:string)
{
  ...
  let cc=[{"route":"leveltopupbywallet"},[{"topupamt":topupamt,"cuserid":cuserid}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
}
...
async magictopup(topupamt:number,cuserid:string)
{
  ...
  let cc=[{"route":"magictopup"},[{"topupamt":topupamt,"cuserid":cuserid}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
}
...
async magictopupbywallet(topupamt:number,cuserid:string)
{
  ...
  let cc=[{"route":"magictopupbywallet"},[{"topupamt":topupamt,"cuserid":cuserid}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
}
...
async topuplistroi(topupid:number,page:number,pagesize:number)
{
  ...
  let cc=[{"route":"topuplistroi"},[{"topupid":topupid,"page":page,"pagesize":pagesize}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
}
...
async directdownlinelist(page:number,pagesize:number)
{
  ...
  let cc=[{"route":"directdownlinelist"},[{"page":page,"pagesize":pagesize}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
...
async diamondlevelmembers(level:number,page:number,pagesize:number)
{
  ...
  let cc=[{"route":"diamondlevelmembers"},[{"level":level,"page":page,"pagesize":pagesize}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
...
async downlinelist(level:number,page:number,pagesize:number)
{
  ...
  let cc=[{"route":"downlinelist"},[{"level":level,"page":page,"pagesize":pagesize}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
  
}

async teambusinesslist(findparam:number,page:number,pagesize:number,fromdate:string,uptodate:string,sortby:string)
{
  
  let cc=[{"route":"teambusiness"},[{"findparam":findparam,"sortby":sortby,"page":page,"pagesize":pagesize,"fromdate":fromdate,"uptodate":uptodate}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
  
}

async directbusiness(findparam:string,page:number,pagesize:number,fromdate:string,uptodate:string)
{
  
  let cc=[{"route":"directbusiness"},[{"findparam":findparam,"page":page,"pagesize":pagesize,"fromdate":fromdate,"uptodate":uptodate}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
  
}

async directteambusiness(findparam:string,page:number,pagesize:number,fromdate:string,uptodate:string)
{
  
  let cc=[{"route":"directteambusiness"},[{"findparam":findparam,"page":page,"pagesize":pagesize,"fromdate":fromdate,"uptodate":uptodate}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
...
async magicdeduction(page:number,pagesize:number)
{
  ...
  let cc=[{"route":"magicdeduction"},[{"page":page,"pagesize":pagesize}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
...
async updateprofile(address:string,otp:string)
{
  ...
  let cc=[{"route":"updatepersonalinfo"},[{"address":address,"otp":otp}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
}  

async updateteamprofile(userid:string,email:string,address:string,password:string,name:string,mobile:string)
{
  
  let cc=[{"route":"updateteampersonalinfo"},[{"cuserid":userid,"email":email,"address":address,"password":password,"name":name,"mobile":mobile}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
}  

async updateprofilered(address:string,name:string,mobile:string,otp:number,email:StringConstructor)
{
  
  let cc=[{"route":"updatepersonalinfored"},[{"address":address,"name":name,"mobile":mobile,"otp":otp,"email":email}]]
  return await lastValueFrom(this.http.post(this.authurl,cc,httpOptions))
}
